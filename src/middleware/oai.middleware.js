...
oai.makeCall = function(callNumber) {
  ...
  client.on('data',function(data) {
    ...
    {
      console.log('CASE 7');
      writeData(outPacket9);
      writeData(outPacket10);
    }
  })
}
